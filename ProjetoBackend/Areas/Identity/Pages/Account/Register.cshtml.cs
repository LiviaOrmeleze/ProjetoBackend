...
namespace ProjetoBackend.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            returnUrl ??= Url.Content("~/"); // Redireciona para a página inicial por padrão
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();

            if (ModelState.IsValid)
            {
                // Cria o usuário e define as propriedades personalizadas
                var user = CreateUser();
                ...
                if (result.Succeeded)
                {
                    ...
                    return LocalRedirect(returnUrl); // Redireciona para a URL de retorno ou página inicial
                }

                // Adiciona erros ao ModelState se houver falhas no registro
            ...
            // Se algo der errado, exibe novamente o formulário com os erros
            return Page();
        }
